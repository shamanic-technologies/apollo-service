...
export const APOLLO_UNDOCUMENTED_FILTERS_ENCART = [
  ...
  "KEYWORDS KILL VOLUME. Free-text q_keywords and technology UIDs are the harshest",
  "volume reducers. Verified: q_keywords=\"SaaS\" -> 86 matches; the SAME intent via",
  "q_organization_keyword_tags=[\"software\"] -> 128,274. NEVER express an industry /",
  "vertical / sector as a q_keywords term or a technology UID — use the keyword-tag",
  "filter below instead. When a count is too low, RELAX q_keywords + technologies",
  "FIRST, before touching seniority / titles / industry.",
