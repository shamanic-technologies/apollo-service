...
const PersonSchema = z
  .object({
    ...
    organizationRevenueUsd: z.string().optional(),
    organizationWebsiteUrl: z.string().optional(),
    organizationLogoUrl: z.string().optional(),
    organizationShortDescription: z.string().optional(),
    organizationSeoDescription: z.string().optional(),
    organizationLinkedinUrl: z.string().optional(),
    organizationTwitterUrl: z.string().optional(),
    organizationFacebookUrl: z.string().optional(),
    organizationBlogUrl: z.string().optional(),
    organizationCrunchbaseUrl: z.string().optional(),
    organizationAngellistUrl: z.string().optional(),
    organizationFoundedYear: z.number().optional(),
    organizationPrimaryPhone: z.string().optional(),
    organizationPubliclyTradedSymbol: z.string().optional(),
    organizationPubliclyTradedExchange: z.string().optional(),
    organizationAnnualRevenuePrinted: z.string().optional(),
    organizationTotalFunding: z.string().optional(),
    organizationTotalFundingPrinted: z.string().optional(),
    organizationLatestFundingRoundDate: z.string().optional(),
    organizationLatestFundingStage: z.string().optional(),
    ...
    organizationStreetAddress: z.string().optional(),
    organizationPostalCode: z.string().optional(),
    ...
    organizationNumSuborganizations: z.number().optional(),
    organizationRetailLocationCount: z.number().optional(),
    organizationAlexaRanking: z.number().optional(),
  })
  .openapi("Person");
